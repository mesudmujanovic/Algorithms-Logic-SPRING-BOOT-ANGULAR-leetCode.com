package com.algorithms.algoLog;
...
public class CreateFunction {
   ...
   public static void create(){
    ...
    public static int brojKorisnikaSaImenom(String ime, List<CreateFunction> podaci) {
        int brojac = 0;
        for (CreateFunction korisnik : podaci) {
            if (korisnik.user.equals(ime)) {
                return brojac = korisnik.count;
            }
        }
        return brojac;
    }
